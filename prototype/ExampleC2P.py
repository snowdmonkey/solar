...
#Then pass these coords to the following method with a GeoTiff image and it will return the nearest pixel location of that gps location
#method has the following form MapPixelCoords(img,XCoord,YCoord) returns a 2 elements list, result[0] is the x pixel, result[1] is the y pixel
